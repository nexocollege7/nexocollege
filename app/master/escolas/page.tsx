            ...
            <div key={escola.id} style={{ backgroundColor: '#1A1A1A', border: '1px solid #2A2A2A', borderRadius: '12px', padding: '20px 24px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <a href={'https://nexocollege.vercel.app/vitrine/' + escola.slug} target="_blank" rel="noreferrer" style={{ padding: '8px 16px', borderRadius: '8px', border: '1px solid #2A2A2A', backgroundColor: 'transparent', color: '#888888', fontSize: '13px', textDecoration: 'none' }}>Vitrine</a>
